...
global script := {  based           : scriptobj
                    ...
                    ,Homepage       : "https://github.com/DreadfullyDespized/ahkglrp"
                    ,crtdate        : "20191018"
                    ,moddate        : ""
...
update(lversion, logurl="", rfile="github", vline=13) {
    ...
    `(rfile = "github") ? logurl := "https://raw.githubusercontent.com/DreadfullyDespized/ahkglrp/master/Changelog.txt"
    ...
    if connected := !ErrorLevel
    {
        ...
        FileReadLine, line, %a_temp%\Changelog.txt, %vline%
        RegexMatch(line, "\d", Version)
        if (rfile = "github") {
            rfile := "https://raw.githubusercontent.com/DreadfullyDespized/ahkglrp/master/AHKGLRP.ahk"
        }
        if (Version > lversion){
